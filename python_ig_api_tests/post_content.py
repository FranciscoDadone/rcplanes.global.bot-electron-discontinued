...
def createMediaObject( params ) :
	...
	API Endpoint:
		https://graph.facebook.com/v6.0/{ig-user-id}/media?image_url={image-url}&caption={caption}&access_token={access-token}
	Returns:
...
def getMediaObjectStatus( mediaObjectId, params ) :
	...
	API Endpoint:
		https://graph.facebook.com/v6.0/{ig-container-id}?fields=status_code
	Returns:
		object: data from the endpoint
	"""
...
params['caption'] = 'This image was posted through the Instagram Graph API.'
# params['caption'] += "\n."
